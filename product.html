					...
					<nav id="nav">
						<ul>
							...
							<li>
								<a href="">Buy</a>
								<ul>
									<li><a href="cayenne.html">RedRock Life</a></li>
									<li><a href="cinnamon.html">RedRock Energy</a></li>
									<li><a href="ginger.html">Ginger</a></li>
				                <li><a href="gingseng.html">Ginseng</a></li>
...
<div class=" fix product-synopsis">
  

<picture class="product-image">
 
  <img class="floatleft" alt="RR1" src="images/16.png"></img>
</a>
  
</picture>


  <form accept-charset="UTF-8" action="" class="cart floatright" method="post">
  <fieldset>
      <p>
        <select class="floatleft" ID="bal" name="variant_id" required="required"><option value="5563"> 10 $9.50</option>
<option value="3648">30  $25.50</option>
<option value="3647">60 $47.50</option>
<option value="3649">90 $65.50</option></select>
        <label ID="chat" class="floatleft" for="product-1132_quantity" title="Quantity of items to add to cart">Qty</label>
        <input  class="floatright" id="product-1132_quantity" max="999" min="1" name="quantity" pattern="[0-9]*" required="required" type="number" value="1" />
      </p>

      <input ID="dhon" class="important small" name="commit" type="submit" value="Add to Cart" />
  </fieldset>
</form>
</div> 
...
<section class="product-detail">
  <nav class="more-information">
    <ul>
      <li class="selected"><a href="#profile-information">Information $$</a></li>
  ...
  <div id="profile-information">
    ...
    <h3>Overview</h3>
    <p><h3>Botanical Name</h3>
<p><em>Olea europaea</em></p>

<h3>Origin</h3>
<p>Spain</p>

<h3>Method of extraction</h3>
<p>Cold Pressed and Unrefined</p>

<h3>Suggested use</h3>
<p>Food and cosmetic use</p>

<h3>Kosher Ce</h3>
<p>Yes</p>

<p>Olive oil is by far the  .</p>

<h3>Typical Analysis</h3>
<p>Color- Deep Olive Green<br />
Odor- Rich and characteristic<br />
Free Fatty Acids- 0.35%<br />
Peroxide Value- 12 <br />
Iodine Value- 52.16<br />
Specific Gravity- less than 0.925<br />
Moisture- 0.08% <br />
pH- 4.12</p>
...
<p>For educational purposes only. This information has not been evaluated by the Food and Drug Administration.
This information is not intended to diagnose, treat, cure, or prevent any disease.</p></p>
</section>
